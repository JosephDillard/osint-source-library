...
The starter collection is US-focused with global hazard, event, aviation, maritime, connectivity and mapping sources. It is not a comprehensive inventory of every jurisdiction or utility.

| Domain | Included | Gap to close for an operating area |
| --- | --- | --- |
| Crime | National statistics, Chicago and NYC reports | Local police open data, reporting lag and permitted call-for-service feeds |
...
| Weather and hazards | Weather alerts, hurricanes, flooding, fires, earthquakes, air quality | Local emergency-management and evacuation notices |
...
| Power | Historical outage data, licensed aggregate option and Austin Energy example | Serving utilities, coverage maps and restoration notices for each site |
| Water | DC Water outage example, USGS water observations and EPA context | Utility-specific outage and boil-water advisories; environmental gauges are not utility outage feeds |
...
## Local sources to add next

For each target city or country, look for:
